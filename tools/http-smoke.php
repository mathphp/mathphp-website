...
try {
    ...
    $optionalChecks = [
        ...
        'numerical-coupled-parabolic-pde' => ['path' => '/?api=pde-coupled-parabolic-numeric', 'payload' => ['system' => 'u_t = u_xx + v; v_t = v_xx', 'variables' => ['u', 'v'], 'initialProfiles' => ['u' => '0', 'v' => '1'], 'leftBoundaries' => ['u' => '0', 'v' => '1'], 'rightBoundaries' => ['u' => '0', 'v' => '1'], 'boundaryConditions' => ['left' => ['u' => ['type' => 'neumann', 'value' => '0']]], 'spacePoints' => 9, 'timeSteps' => 2], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'explicit-coupled-parabolic-finite-difference' && ($body['analysis']['solution']['boundaryConditions']['left']['u']['type'] ?? null) === 'neumann' && (float) ($body['analysis']['solution']['final']['values']['v'][4] ?? NAN) === 1.0, 'unavailable' => 'explain.unavailable'],
