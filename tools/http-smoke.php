...
try {
    ...
    $optionalChecks = [
        ...
        'numerical-wave-pde' => ['path' => '/?api=pde-wave-numeric', 'payload' => ['equation' => 'u_tt = c^2*u_xx', 'initialDisplacement' => '1', 'initialVelocity' => '0', 'leftBoundary' => '1', 'rightBoundary' => '1', 'known' => ['c' => 2], 'spacePoints' => 17, 'timeSteps' => 8], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'explicit-wave-finite-difference' && abs((float) ($body['analysis']['solution']['final']['values'][8] ?? NAN) - 1.0) < 1e-10, 'unavailable' => 'explain.unavailable'],
        ...
        'numerical-wave-pde-2d' => ['path' => '/?api=pde-wave-2d-numeric', 'payload' => ['equation' => 'u_tt = u_xx + u_yy', 'initialDisplacement' => '1', 'initialVelocity' => '0', 'leftBoundary' => '1', 'rightBoundary' => '1', 'bottomBoundary' => '1', 'topBoundary' => '1', 'firstPoints' => 7, 'secondPoints' => 7, 'timeSteps' => 2, 'targetTime' => 0.05], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'explicit-2d-wave-finite-difference' && abs((float) ($body['analysis']['solution']['final']['values'][3][3] ?? NAN) - 1.0) < 1e-10, 'unavailable' => 'explain.unavailable'],
