...
try {
    ...
    $optionalChecks = [
        ...
        'system' => ['path' => '/?api=system', 'payload' => ['system' => '2x + 3y = 8; 1x - 1y = 1'], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && count($body['analysis']['steps'] ?? []) > 0, 'unavailable' => 'explain.unavailable'],
