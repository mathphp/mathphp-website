...
try {
    ...
    foreach (['evaluate', 'complex-evaluate', 'complex-equation', 'explain', 'piecewise', 'piecewise-equation', 'equation', 'inequality', 'system', 'matrix', 'calculus', 'plot', 'area', 'root', 'statistics', 'units', 'unit-explain', 'numerical-second-order-ode'] as $id) {
    ...
    foreach (['complex-evaluate', 'complex-equation', 'explain', 'piecewise', 'piecewise-equation', 'equation', 'inequality', 'system', 'matrix', 'calculus', 'area', 'root', 'statistics', 'units', 'unit-explain', 'plot', 'numerical-second-order-ode'] as $id) {
