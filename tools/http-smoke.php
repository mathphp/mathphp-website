...
try {
    ...
    $optionalChecks = [
        ...
        'numerical-elliptic-pde' => ['path' => '/?api=pde-elliptic-numeric', 'payload' => ['equation' => 'u_xx + u_yy = 0', 'leftBoundary' => '0', 'rightBoundary' => '1', 'bottomBoundary' => '1', 'topBoundary' => '1', 'boundaryConditions' => ['left' => ['type' => 'neumann', 'value' => '0']], 'firstPoints' => 15, 'secondPoints' => 15, 'iterations' => 3000], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'gauss-seidel-elliptic' && ($body['analysis']['solution']['boundaryConditions']['left']['type'] ?? null) === 'neumann' && abs((float) ($body['analysis']['solution']['grid'][7][7] ?? NAN) - 1.0) < 1e-6, 'unavailable' => 'explain.unavailable'],
