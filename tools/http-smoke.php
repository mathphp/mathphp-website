...
try {
    ...
    foreach (['evaluate', 'complex-evaluate', 'complex-equation', 'explain', 'piecewise', 'piecewise-equation', 'equation', 'inequality', 'system', 'matrix', 'calculus', 'plot', 'area', 'root', 'statistics', 'units', 'unit-explain', 'numerical-second-order-ode', 'numerical-higher-order-ode', 'numerical-pde', 'numerical-boundary-value-ode', 'numerical-elliptic-pde', 'numerical-wave-pde', 'numerical-wave-pde-2d', 'numerical-parabolic-pde-2d', 'numerical-coupled-parabolic-pde', 'recurrence', 'limit'] as $id) {
    ...
    foreach (['complex-evaluate', 'complex-equation', 'explain', 'piecewise', 'piecewise-equation', 'equation', 'inequality', 'system', 'matrix', 'calculus', 'area', 'root', 'statistics', 'units', 'unit-explain', 'plot', 'numerical-second-order-ode', 'numerical-higher-order-ode', 'numerical-pde', 'numerical-boundary-value-ode', 'numerical-elliptic-pde', 'numerical-wave-pde', 'numerical-wave-pde-2d', 'numerical-parabolic-pde-2d', 'numerical-coupled-parabolic-pde', 'recurrence', 'limit'] as $id) {
    ...
    $pageChecks = [
        ...
        '/?page=explaining-bvp' => 'Boundary-value ODEs',
        '/?page=explaining-pde-2d' => 'Two-dimensional',
        '/?page=explaining-pde-elliptic-2d' => 'Two-dimensional',
        '/?page=explaining-pde-coupled' => 'Coupled',
        '/?page=explaining-pde-wave-2d' => 'Two-dimensional',
    ...
    $optionalChecks = [
        ...
        'numerical-pde' => ['path' => '/?api=pde-numeric', 'payload' => ['equation' => 'u_t = 0.1*u_xx^2', 'initialProfile' => '0', 'leftBoundary' => '0', 'rightBoundary' => '0', 'boundaryConditions' => ['left' => ['type' => 'neumann', 'value' => '0'], 'right' => ['type' => 'dirichlet', 'value' => '0']], 'spacePoints' => 17, 'timeSteps' => 8], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'explicit-finite-difference' && ($body['analysis']['solution']['operatorMode'] ?? null) === 'direct-nonlinear' && ($body['analysis']['solution']['boundaryConditions']['left']['type'] ?? null) === 'neumann' && abs((float) ($body['analysis']['solution']['final']['values'][8] ?? NAN)) < 1e-10, 'unavailable' => 'explain.unavailable'],
        'numerical-boundary-value-ode' => ['path' => '/?api=ode-boundary-numeric', 'payload' => ['equation' => "y'' = 0", 'leftBoundary' => '0', 'rightBoundary' => '1', 'steps' => 40, 'iterations' => 40], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'shooting-rk4' && abs((float) ($body['analysis']['solution']['initialSlope'] ?? NAN) - 1.0) < 1e-7, 'unavailable' => 'explain.unavailable'],
        'numerical-elliptic-pde' => ['path' => '/?api=pde-elliptic-numeric', 'payload' => ['equation' => 'u_xx + u_yy + 0.25*u_xy = 0', 'leftBoundary' => '0', 'rightBoundary' => '1', 'bottomBoundary' => '1', 'topBoundary' => '1', 'boundaryConditions' => ['left' => ['type' => 'neumann', 'value' => '0']], 'firstPoints' => 7, 'secondPoints' => 7, 'iterations' => 300], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'gauss-seidel-elliptic' && ($body['analysis']['solution']['boundaryConditions']['left']['type'] ?? null) === 'neumann' && abs((float) ($body['analysis']['solution']['grid'][3][3] ?? NAN) - 1.0) < 1e-6, 'unavailable' => 'explain.unavailable'],
        'numerical-wave-pde' => ['path' => '/?api=pde-wave-numeric', 'payload' => ['equation' => 'u_tt = c^2*u_xx', 'initialDisplacement' => '1', 'initialVelocity' => '0', 'leftBoundary' => '1', 'rightBoundary' => '1', 'boundaryConditions' => ['left' => ['type' => 'neumann', 'value' => '0']], 'known' => ['c' => 2], 'spacePoints' => 17, 'timeSteps' => 8], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'explicit-wave-finite-difference' && ($body['analysis']['solution']['boundaryConditions']['left']['type'] ?? null) === 'neumann' && abs((float) ($body['analysis']['solution']['final']['values'][8] ?? NAN) - 1.0) < 1e-10, 'unavailable' => 'explain.unavailable'],
        'numerical-parabolic-pde-2d' => ['path' => '/?api=pde-parabolic-2d-numeric', 'payload' => ['equation' => 'u_t = vx*u_x + vy*u_y + alpha*u_xx + beta*u_yy + gamma*u_xy', 'initialProfile' => '1', 'leftBoundary' => '1', 'rightBoundary' => '1', 'bottomBoundary' => '1', 'topBoundary' => '1', 'boundaryConditions' => ['left' => ['type' => 'neumann', 'value' => '0']], 'known' => ['vx' => 0.1, 'vy' => -0.1, 'alpha' => 0.1, 'beta' => 0.1, 'gamma' => 0.05], 'firstPoints' => 5, 'secondPoints' => 5, 'timeSteps' => 1, 'targetTime' => 0.02], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'explicit-2d-parabolic-finite-difference' && ($body['analysis']['solution']['boundaryConditions']['left']['type'] ?? null) === 'neumann' && abs((float) ($body['analysis']['solution']['final']['values'][2][2] ?? NAN) - 1.0) < 1e-10, 'unavailable' => 'explain.unavailable'],
        'numerical-coupled-parabolic-pde' => ['path' => '/?api=pde-coupled-parabolic-numeric', 'payload' => ['system' => 'u_t = a*u_x + u_xx + v; v_t = b*v_x + v_xx', 'variables' => ['u', 'v'], 'initialProfiles' => ['u' => '0', 'v' => '1'], 'leftBoundaries' => ['u' => '0', 'v' => '1'], 'rightBoundaries' => ['u' => '0', 'v' => '1'], 'known' => ['a' => 0.2, 'b' => -0.1], 'boundaryConditions' => ['left' => ['u' => ['type' => 'neumann', 'value' => '0']]], 'spacePoints' => 9, 'timeSteps' => 2], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'explicit-coupled-parabolic-finite-difference' && ($body['analysis']['solution']['boundaryConditions']['left']['u']['type'] ?? null) === 'neumann' && (float) ($body['analysis']['solution']['final']['values']['v'][4] ?? NAN) === 1.0, 'unavailable' => 'explain.unavailable'],
        'numerical-wave-pde-2d' => ['path' => '/?api=pde-wave-2d-numeric', 'payload' => ['equation' => 'u_tt = u_xx + u_yy + 0.25*u_xy', 'initialDisplacement' => '1', 'initialVelocity' => '0', 'leftBoundary' => '1', 'rightBoundary' => '1', 'bottomBoundary' => '1', 'topBoundary' => '1', 'boundaryConditions' => ['left' => ['type' => 'neumann', 'value' => '0']], 'firstPoints' => 7, 'secondPoints' => 7, 'timeSteps' => 2, 'targetTime' => 0.05], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'explicit-2d-wave-finite-difference' && ($body['analysis']['solution']['boundaryConditions']['left']['type'] ?? null) === 'neumann' && abs((float) ($body['analysis']['solution']['final']['values'][3][3] ?? NAN) - 1.0) < 1e-10, 'unavailable' => 'explain.unavailable'],
