...
try {
    ...
    $optionalChecks = [
        ...
        'numerical-elliptic-pde' => ['path' => '/?api=pde-elliptic-numeric', 'payload' => ['equation' => 'u_xx + u_yy = 0', 'leftBoundary' => 'y', 'rightBoundary' => '1+y', 'bottomBoundary' => 'x', 'topBoundary' => 'x+1', 'firstPoints' => 15, 'secondPoints' => 15, 'iterations' => 3000], 'success' => static fn (array $body): bool => ($body['analysis']['status'] ?? null) === 'solved' && ($body['analysis']['solution']['method'] ?? null) === 'gauss-seidel-elliptic' && abs((float) ($body['analysis']['solution']['grid'][7][7] ?? NAN) - 1.0) < 1e-6, 'unavailable' => 'explain.unavailable'],
