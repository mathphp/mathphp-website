...
function renderGuide(string $guide): string
{
    $guides = [
        ...
        'visuals-rendering' => ['Visuals add-on', 'Rendering pipeline', 'Keep representations portable: generate structured data first, then choose SVG, Canvas, or your own renderer.', '<h2>Renderer-neutral by design.</h2><p><code>VisualRepresentation</code> is the hand-off point between analysis and presentation. <code>Plotter</code> creates samples and metadata; <code>SvgRenderer</code> turns supported models into embeddable, accessible SVG.</p><pre class="code-block"><code><span class="code-keyword">$representation</span> = <span class="code-keyword">new</span> VisualRepresentation(<span class="code-string">\'line-plot\'</span>, [<span class="code-string">\'points\'</span> =&gt; $points]);<br><span class="code-keyword">$svg</span> = (<span class="code-keyword">new</span> SvgRenderer())-&gt;render(<span class="code-keyword">$representation</span>);</code></pre><div class="guide-grid"><div><h3>Accessibility</h3><p>Include titles, labels, and a text summary beside every visual.</p></div><div><h3>Portability</h3><p>Serialize the model over JSON and render it in any frontend.</p></div></div>'],
    ];
