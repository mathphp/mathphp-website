...
function renderPackage(string $package): string
{
    ...
    $install = $explaining
        ? '<div class="package-code package-install"><span class="code-comment"># add approved private VCS sources</span><br>composer config repositories.mathphp-visuals vcs https://github.com/mathphp/mathphp-visuals.git<br>composer config repositories.mathphp-explaining vcs https://github.com/mathphp/mathphp-explaining.git<br>composer require mathphp/mathphp-visuals:dev-main mathphp/mathphp-explaining:dev-main</div>'
        : ($units ? '<div class="package-code package-install"><span class="code-comment"># add the approved private VCS source</span><br>composer config repositories.mathphp-units vcs https://github.com/mathphp/mathphp-units.git<br>composer require mathphp/mathphp-units:dev-main</div>' : '<div class="package-code package-install"><span class="code-comment"># add the approved private VCS source</span><br>composer config repositories.mathphp-visuals vcs https://github.com/mathphp/mathphp-visuals.git<br>composer require mathphp/mathphp-visuals:dev-main</div>');
    $showcase = $explaining
