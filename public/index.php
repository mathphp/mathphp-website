...
function handleCapabilitiesRequest(): never
{
    ...
    $capabilities = [
        ...
        ['id' => 'numerical-pde', 'endpoint' => '?api=pde-numeric', 'input' => 'bounded 1D parabolic PDE with affine u_x/u_xx advection–diffusion terms, initial profile, Dirichlet/Neumann/Robin boundaries, finite grid/time limits', 'visualKinds' => ['pde-heatmap'], 'requiredPackages' => ['core', 'explaining'], 'available' => $state['core'] && $state['optional']['explaining']],
