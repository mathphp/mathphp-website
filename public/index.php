...
function handleCapabilitiesRequest(): never
{
    ...
    $capabilities = [
        ...
        ['id' => 'numerical-coupled-parabolic-pde', 'endpoint' => '?api=pde-coupled-parabolic-numeric', 'input' => 'bounded coupled 1D parabolic system with per-field affine u_x/u_xx transport-diffusion terms, profiles, Dirichlet/Neumann/Robin edges, CFL-limited time grid', 'visualKinds' => ['pde-system-heatmap'], 'requiredPackages' => ['core', 'explaining'], 'available' => $state['core'] && $state['optional']['explaining']],
