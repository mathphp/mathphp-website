...
function renderPackage(string $package): string
{
    ...
    return '<section class="page-intro wrap"><div class="eyebrow"><span class="eyebrow-dot"></span>Private extension</div><h1>' . $title . '<br><em>' . e($name) . '</em></h1><p>' . $description . '</p></section>'
        ...
        . '<section class="package-guides wrap"><div class="section-kicker">Feature guides</div><div class="package-guide-links">' . ($explaining ? '<a href="?page=explaining-steps"><strong>Step-by-step evaluation</strong><span>Build a lesson from each operation →</span></a><a href="?page=explaining-translations"><strong>Translations & observers</strong><span>Localize and instrument safely →</span></a>' : '<a href="?page=visuals-plots"><strong>Plots & sampling</strong><span>Turn formulas into portable data →</span></a><a href="?page=visuals-analysis"><strong>Equations & calculus</strong><span>Model richer mathematical interfaces →</span></a>') . '</div></section>';
}
