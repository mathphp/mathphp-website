...
function renderLayout(string $title, string $content, string $active): string
{
    ...
    return '<!doctype html><html lang="en"><head><meta charset="utf-8">'
        ...
        . '<header class="site-header"><a class="brand" href="?page=home"><span class="brand-mark">∑</span><span>MathPHP</span><small class="brand-badge">PHP math library</small></a>'
