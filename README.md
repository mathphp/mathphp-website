...
the reviewed Core `v0.2.0` revision instead of resolving a moving branch at
build time. For
...
the requested ref (defaulting to `v0.2.0`) before installing dependencies, and the health/version
