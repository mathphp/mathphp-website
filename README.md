...
the reviewed Core `v0.3.0` revision instead of resolving a moving branch at
build time. For
...
the requested ref (defaulting to `v0.3.0`) before installing dependencies, and the health/version
...
The Explaining add-on defaults to its compatible `v0.19.2` patch release.
