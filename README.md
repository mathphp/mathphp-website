...
the reviewed Core `v0.3.4` revision instead of resolving a moving branch at
build time. For
...
the requested ref (defaulting to `v0.3.5`) before installing dependencies, and the health/version
...
The Explaining add-on defaults to its compatible `v0.27.0` release. Units and
Visuals default to their compatible `v0.3.5` releases.
